...
# 不同的类别结果对应不同的高度
# 基于数据点的坐标与高度数据，绘制等高线
def draw_decision_boundary(minx, maxx, miny, maxy, model):
    # 生成网格数据点
...
if __name__ == '__main__':
    draw_data()
    xx, xy, z = draw_decision_boundary(-4, 4, -4, 4, make_model())
    # contour绘制多分类的决策边界
    plt.contour(xx, xy, z, colors=['orange'])
    plt.show()
